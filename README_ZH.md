...
### windows桌面版安装
  ...
  👉 [点击下载](https://github.com/heshengtao/super-agent-party/releases/download/v0.1.4/Super-Agent-Party-Setup-0.1.4.exe)
...
`.AppImage` 是一种无需安装、即开即用的 Linux 应用格式。适用于大多数 Linux 发行版。
  ...
  👉 [点击下载](https://github.com/heshengtao/super-agent-party/releases/download/v0.1.4/Super-Agent-Party-0.1.4-Linux.AppImage)


#### 2. 使用 `.deb` 包安装（适用于 Ubuntu / Debian 系统）

  👉 [点击下载](https://github.com/heshengtao/super-agent-party/releases/download/v0.1.4/Super-Agent-Party-0.1.4-Linux.deb)
...
2. 添加文件/图片链接查看工具，可以让大模型能根据用户发送的URL来获取文件/图片信息。也可以用来查看服务器内部的文件或者图片信息，甚至是聊天记录中的工具结果。工具结果将不占用上下文，而是作为单独的文件存储，可以供大模型随时查看，实现大模型的备忘录功能。
...
7. 主模型配置界面支持了额外参数的配置，配置一些自定义参数。
8. 知识库支持了混合搜索功能，可以选择关键词搜索和语义搜索之间的比例。
...
10. 已实现的小工具：当前时间、获取文件/图片URL中的内容、伪推理、Pollinations 图像生成、latex公式渲染增强、语言语气。
  - 当前时间：获取当前时间。
